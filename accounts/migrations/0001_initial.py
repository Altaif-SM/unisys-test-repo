# Generated by Django 2.0.6 on 2018-07-02 08:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': (('can_view_year_master', 'can view year master'),),
            },
            managers=[
        ...
        migrations.AddField(
            model_name='user',
            name='role',
            field=models.ManyToManyField(null=True, related_name='user_role', to='accounts.UserRole'),
        ),
        migrations.AddField(
            model_name='user',
