...
urlpatterns = [
    ...
    path('add_supervisor_committee/', user_login_required(views.add_supervisor_committee),name='add_supervisor_committee'),
    path('edit_supervisor_committee/<int:supervisor_id>/', views.edit_supervisor_committee,name='edit_supervisor_committee'),
    path('supervisor_committee/', user_login_required(views.supervisor_committee),name='supervisor_committee'),
    ...
    path('list_online_progress_report/', views.OnlineProgressReportList.as_view(), name='list_online_progress_report'),
    ...
    path('update_online_progress/<int:report_id>/', user_login_required(views.update_online_progress), name='update_online_progress'),
