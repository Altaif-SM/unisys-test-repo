...
urlpatterns = [
    ...
    path('get_departments_from_faculty_2/', views.get_departments_from_faculty_2, name='get_departments_from_faculty_2'),
    path('get_departments_from_faculty_3/', views.get_departments_from_faculty_3, name='get_departments_from_faculty_3'),
    ...
    path('get_programs_from_faculty_2/', views.get_programs_from_faculty_2, name='get_programs_from_faculty_2'),
    path('get_programs_from_faculty_3/', views.get_programs_from_faculty_3, name='get_programs_from_faculty_3'),
    ...
    path('get_semester_from_university/', views.get_semester_from_university, name='get_semester_from_university'),
    path('get_year_from_study_level/', views.get_year_from_study_level, name='get_year_from_study_level'),
    ...
    path('get_faculty_from_study_mode_2/', views.get_faculty_from_study_mode_2, name='get_faculty_from_study_mode_2'),
    path('get_faculty_from_study_mode_3/', views.get_faculty_from_study_mode_3, name='get_faculty_from_study_mode_3'),
    path('get_faculty_from_study_level/', views.get_faculty_from_study_level, name='get_faculty_from_study_level'),
    path('get_faculty_from_study_level_2/', views.get_faculty_from_study_level_2, name='get_faculty_from_study_level_2'),
    path('get_faculty_from_study_level_3/', views.get_faculty_from_study_level_3, name='get_faculty_from_study_level_3'),
    ...
    path('get_program_mode_from_selected_program_2/', views.get_program_mode_from_selected_program_2, name='get_program_mode_from_selected_program_2'),
    path('get_program_mode_from_selected_program_3/', views.get_program_mode_from_selected_program_3, name='get_program_mode_from_selected_program_3'),
