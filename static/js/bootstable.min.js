...
function rowEdit(t) {
    ...
    ModoEdicion(n) || (IterarCamposEdit(i, function (t) {
        var n = t.html(), i = '<div style="display: none;">' + n + "</div>",
            o = '<input class="form-control input-sm val"  value="' + n + '">';
        t.html(i + o)
    }), FijModoEdit(t))
}
