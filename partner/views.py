    ...
    try:
        ...
        for application in applicant_recs:
            try:
                ...
                temp_list.append(application.address.residential_address.title())
                temp_list.append(application.address.sub_locality.title())
                temp_list.append(application.address.post_code)
                temp_list.append(application.address.district.title())
                temp_list.append(application.address.state.title())
