...
import os
from masters.models import AllCountries,ReligionDetails
...
def import_relgions():
    relgion_list = ['Jainism','Buddhism','Hinduism','Christianity','Gnosticism','Islam','Judaism','Sikhism']
    for rec in relgion_list:
        print(rec)
        ReligionDetails.objects.create(religion_name=rec)
