...
class StudentDetails(BaseModel):
    ...
    photo = models.FileField(upload_to=content_file_name_image)
    ...
    address = models.ForeignKey('masters.AddressDetails', null=True, related_name='student_address_rel', on_delete=models.PROTECT)
...
class SiblingDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='sibling_applicant_rel',
                                on_delete=models.PROTECT)
...
class AcademicQualificationDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='academic_applicant_rel',
                                on_delete=models.PROTECT)
...
class EnglishQualificationDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='english_applicant_rel',
                                on_delete=models.PROTECT)
...
class CurriculumDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='curriculum_student_rel',
                                on_delete=models.PROTECT)
...
class ExperienceDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='applicant_experience_rel',
                                on_delete=models.PROTECT)
...
class ScholarshipSelectionDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='applicant_scholarship_rel',
                                on_delete=models.PROTECT)


class ApplicantAboutDetails(BaseModel):
    about_yourself = models.CharField(max_length=255, blank=True, null=True)
    student = models.ForeignKey(StudentDetails, null=True, related_name='applicant_about_rel',
                                on_delete=models.PROTECT)
...
class ApplicantPsychometricTestDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='applicant_psychometric_test_rel',
                                on_delete=models.PROTECT)
...
class ApplicantAgreementDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='applicant_agreement_rel',
                                on_delete=models.PROTECT)
...
class ApplicantAcademicProgressDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='applicant_progress_rel',
                                on_delete=models.PROTECT)
...
class ApplicantDevelopmentProgramDetails(BaseModel):
    ...
    student = models.ForeignKey(StudentDetails, null=True, related_name='development_program_student_rel',
                                on_delete=models.PROTECT)
