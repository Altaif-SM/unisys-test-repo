...
urlpatterns = [
                ...
                #========import_student_application======================
                  ...
                  path('research_plan_registration/', views.research_plan_registration, name='research_plan_registration'),
                  ...
                  path('get_research_semester_from_year/', views.get_research_semester_from_year, name='get_research_semester_from_year'),
                  ...
                  path('get_supervisor_from_filter/', views.get_supervisor_from_filter, name='get_supervisor_from_filter'),
